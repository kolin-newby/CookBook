...
const About = () => {
  return (
    <div className="flex flex-col sm:flex-row w-full h-full p-10 space-x-6 items-center justify-center">
      ...
      <article className="max-h-full overflow-y-scroll flex-col px-1 py-4 text-theme-5 sm:max-w-2/3 w-full flex-1 sm:space-y-4 text-sm sm:text-base md:text-lg text-wrap">
        <div className="relative float-left p-3 mr-3 mb-1 w-1/2 aspect-square">
        ...
        <div className="relative float-right p-3 ml-3 my-1 w-1/2 aspect-square">
